This script helps you add Microsoft Store for Windows LTSC 2021 and later.
...
- Thanks kkkgo for the base script:
  https://github.com/kkkgo/LTSC-Add-MicrosoftStore/blob/master/Add-Store.cmd
- Thanks kkkgo for winget downloading function:
